...
/**
 * The class ProductController implements BasicGetController<Product>
 * @author Raihan Wijaya
 * @description Digunakan untuk sebagai controller dari product, seperti membuat produk, memfilter produk dan mengambil produk dari store
 */
